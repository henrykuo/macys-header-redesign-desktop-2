...
$__System.register('b', ['7', '9', 'a'], function (_export) {
	...
	function show_cat() {
		...
		// SET HEIGHT AND POSITION OF FLYOUT
		flyout_set_height_and_pos();

		// GET OTHER DATA TO USE FOR ANGLES
		...
		var angleTopHeight = linkYPerc * 100 * 2.5;
		var angleBottomHeight = reversePerc * 100 * 2;
		//if (angleTopHeight < 60) {angleTopHeight = 60;}
		//if (angleBottomHeight < 30) {angleBottomHeight = 30;}
	...
	// ----------------- SET HEIGHT AND POSITION OF FLYOUT -----------------
	function flyout_set_height_and_pos() {
		var refPoint1 = $flyoutPosRef1.offset().top;
		var refPoint2 = $flyoutPosRef2.offset().top;
		var diff = refPoint2 - refPoint1;
		$menuFlyout.css({ 'min-height': diff });
		if (refPoint1 < 48) {
			refPoint1 = 48;
		}
	...
	return {
		...
		execute: function () {
			...
			$menuBottomLink.on('mouseenter', function () {
				debounce_hide_flyout();
			});
